...
COVER = 'F:/homework/2023小学期/代码/fatigue_detecting-master/images/camera.png'
...
class Fatigue_detecting(wx.Frame):
    ...
    def _learning_face(self,event):
        ...
        self.predictor = dlib.shape_predictor("E:/data/shape_predictor_68_face_landmarks.dat")
                ...
                for k, d in enumerate(faces):
                    ...
                    if self.nod_checkBox7.GetValue()== True:
                        ...
                        for start, end in self.line_pairs:
                            cv2.line(im_rd, tuple(map(int, reprojectdst[start])), tuple(map(int, reprojectdst[end])), (0, 0, 255))
                        # 显示角度结果
